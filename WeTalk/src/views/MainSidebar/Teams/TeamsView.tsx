...
const TeamsView: React.FC<ITeamsViewProps> = ({
  ...
  return (
    <div className="min-h-screen sm:min-h-screen md:min-h-screen lg:min-h-screen px-4 py-8 border-r overflow-y-auto bg-secondary w-full sm:w-1/3 md:w-1/3 lg:w-[3000px] xl:w-[3000px] 2xl:w-full">
      <SearchBar />
